...
MEMORY
{
    ...
    /*   但し、ROMエミュレーション機能をstubで使用する               */
    /*   内蔵RAMはstub専用の領域となるので注意すること               */
    vectors	: o = 0xffe100, l = 0x100
        /* 0xffe000 - 0xffe0ff : stubの(実)割り込みベクタで使用 */
	/* 0xffe100 - 0xffe1ff : ユーザプログラムの(仮想)割り込みベクタ */
    /* RAM領域を特に分断しないで詰めてロードする */
    ram		: o = 0x200000, l = 0x1f700
}
SECTIONS                
{                   
.vectors : {
