/*
  H8-3052F ROM版リンカスクリプト (スタック領域とデータ領域が内蔵RAM)
  2008/4/3 和崎
*/
...
/*   ROM化するプログラムのデータとスタックが4kBを越えると使用不可    */
/*   ROM化する場合、必ず内蔵RAMを初期状態のスタック領域に使う */
PROVIDE(_stack = 0xffff10);
/*   外部RAMをスタックとして使用する場合に必要 */
